...
let quizArray = [
  {
    ...
    options: ["Imran Khan", "Muhammad Ali", "Uzair Baloch", "Abdul Rehman"],
    correct: 0,
    image: "img/pm.jpg",
  },
  {
  ...
  {
    question:
      "who is the Army Chief of Pakistan",
    options: [
      "Qamar javed Bajwa",
      "Pervaiz Musharraf",
      "Pervaiz Kayani",
  ...
  {
    question:
      "On 8 February 2021 China donated vaccine to first military in the world. That military is of ?      ",
    options: [
      "Pakistan",
      "India",
      "Bangladesh",
  ...
  },
  {
    ...
    options: ["Arif Alvi", "Mamnoon Hussain", "Yasir Hussain", "Farhat Hashmi"],
    correct: 0,
    image: "img/pd.jpg",
  },
  {
    question: "Who became first Prime Minister of Pakistan",
    options: ["Liaquat Ali Khan", "Khaja Nizamuddin", "Muhammad Ali Bhora", "Ghulam Muhammad"],
    correct: 0,
    image: "img/pm1.jpg",
  },
  {
    question:
      "When did Pakistan become Nuclear Country",
    options: ["28th May 1998", "30 Aug 1998","15 Sep 1998","15 Aug 1998"],
    correct: 0,
    image: "img/nc.jpg",
  },
  {
    question:
      "Who was last Governor General of Pakistan",
    options: ["Iskander Mirza", "Quaid-e-Azam", "Ghulam Muhammad", "Khawja Nizamuddin"],
    correct: 0,
    image: "img/ggm.jpg",
  }];
